...
public class FileGroupLocalServiceClpInvoker {
	public FileGroupLocalServiceClpInvoker() {
		...
		_methodName87 = "getFileGroupByD_P";

		_methodParameterTypes87 = new String[] { "long", "long" };

		_methodName88 = "getFileGroupByDossierId";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName87.equals(name) &&
			...
			return FileGroupLocalServiceUtil.getFileGroupByD_P(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}
