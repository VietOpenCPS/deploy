...
import org.opencps.dossiermgt.service.filegroupLocalService;
...
/**
 * Provides the base implementation for the filegroup local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.filegroupLocalServiceImpl}.
 * </p>
 *
 * @author trungnt
 ...
 * @generated
 */
public abstract class filegroupLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements filegroupLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.filegroupLocalServiceUtil} to access the filegroup local service.
	 */
	...
	private filegroupLocalServiceClpInvoker _clpInvoker = new filegroupLocalServiceClpInvoker();
}