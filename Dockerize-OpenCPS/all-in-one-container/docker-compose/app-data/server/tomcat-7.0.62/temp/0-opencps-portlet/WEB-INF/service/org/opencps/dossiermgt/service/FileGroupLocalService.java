...
/**
 * Provides the local service interface for FileGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungnt
 * @see FileGroupLocalServiceUtil
...
public interface FileGroupLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FileGroupLocalServiceUtil} to access the file group local service. Add custom service methods to {@link org.opencps.dossiermgt.service.impl.FileGroupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
