...
import org.opencps.dossiermgt.service.DossierStatusService;
...
/**
 * Provides the base implementation for the dossier status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DossierStatusServiceImpl}.
 * </p>
 *
 * @author trungnt
 ...
 * @generated
 */
public abstract class DossierStatusServiceBaseImpl extends BaseServiceImpl
	implements DossierStatusService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DossierStatusServiceUtil} to access the dossier status remote service.
	 */
	...
	private DossierStatusServiceClpInvoker _clpInvoker = new DossierStatusServiceClpInvoker();
}